  ...
  void _onScroll() {
    for (int i = 0; i < sectionKeys.length; i++) {
      ...
      if (ctx != null) {
        ...
        // You can adjust the offset threshold as needed
          ...
          child: ListView(
            children: [
              ...List.generate(
                ...
                (index) => ListTile(
                  leading: Image.asset(navIcons[index]),
                  title: Text(sectionsListTitle[index]),
                  selected:
                      currentSectionIndex == index, // highlight if selected
                  selectedTileColor: context.theme.primaryColor
                      .withOpacity(0.12), // highlight color
                  onTap: () {
...
class FrostedAppBar extends StatelessWidget {
  ...
  const FrostedAppBar({Key? key, this.actions}) : super(key: key);
